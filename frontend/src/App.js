      ...
      <Router>
          <main className='u-fx u-fx-column'>
              <Switch>
                  ...
                  <PrivateRoute exact path={`${URL_REPO.EDIT_PROJECT}/:id`} component = {EditProject}/>
                  <PrivateRoute exact path={`${URL_REPO.SHOW_PROJECT}/:id${URL_REPO.TO_DO_LIST}`} component= {ShowToDo}/>
                  <PrivateRoute exact path={`${URL_REPO.SHOW_PROJECT}/:id${URL_REPO.TO_DO_LIST}${URL_REPO.ADD_TASK}`} component= {AddTask} />
                  <PrivateRoute exact path={`${URL_REPO.SHOW_PROJECT}/:id${URL_REPO.TO_DO_LIST}${URL_REPO.EDIT_TASK}/:id`} component= {EditTask}/>
